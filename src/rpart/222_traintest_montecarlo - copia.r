...
ksemillas  <- c(211403, 311453, 411473, 511467, 611441
                , 100019, 100049, 100067, 100059, 100109
                , 100129, 100169, 100189, 100207, 100237
                , 100267, 100279, 100297, 100357, 100379) #reemplazar por las propias semillas
...
# 5 semillas, ganancia 52.898.000
# 20 semillas, ganancia 52.629.000
