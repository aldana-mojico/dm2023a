...
PARAM$rpart$cp         <-  -0.790816557951701
PARAM$rpart$minsplit   <- 463.815444480944
PARAM$rpart$minbucket  <- 231.761677116049
PARAM$rpart$mixdepth   <-   14

PARAM$prob_corte       <-   0.05254341386124
