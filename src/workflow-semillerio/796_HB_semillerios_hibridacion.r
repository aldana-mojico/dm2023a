...
PARAM  <- list()
PARAM$experimento  <- "HB7960V14V14V144V145TAV16TA"

PARAM$exp_input  <- c("ZZ7950US005V14Sem5S150", "ZZ7950US005V14S150", "ZZ7950US005V14Rank4S150", "ZZ7950US005V14TAS150", "ZZ7950US005V16TAS150" )  # el inpput deben ser semillerios

# HB7960V14V14TA  "ZZ7950US005V14S150", "ZZ7950US005V14TAS150"
# HB7960V14V16TA  "ZZ7950US005V14S150", "ZZ7950US005V16TAS150"
# HB7960V14TAV16TA  "ZZ7950US005V14TAS150", "ZZ7950US005V16TAS150"
# HB7960V14V14TAV16TA  "ZZ7950US005V14S150", "ZZ7950US005V14TAS150", "ZZ7950US005V16TAS150"
# HB7960V144V16TA  "ZZ7950US005V14Rank4S150", "ZZ7950US005V16TAS150"
# HB7960V14V14V144TAV16TA  "ZZ7950US005V14S150", "ZZ7950US005V14Rank4S150", "ZZ7950US005V14TAS150", "ZZ7950US005V16TAS150"
# HB7960V14V14V144V145TAV16TA  "ZZ7950US005V14Sem5S150", ZZ7950US005V14S150", "ZZ7950US005V14Rank4S150", "ZZ7950US005V14TAS150", "ZZ7950US005V16TAS150"
...
verificacion_rapida  <- function( home_dir, exp_input )
{
  ...
  i  <- 1L
  while( dir.exists(file.path(home_dir, "expfinal", exp_input[i] )) )  i  <- i + 1L
  ...
  i  <- 1L
  while( length( list.files( file.path(home_dir, "expfinal", exp_input[i] ),
...
dir.create( paste0( PARAM$home, "expfinal/", PARAM$experimento, "/"), showWarnings= FALSE )
setwd(paste0( PARAM$home, "expfinal/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
...
for( exp_input  in  PARAM$exp_input )
{
  ...
  predicciones  <- list.files( file.path( PARAM$home, "expfinal", exp_input),
                               pattern= "^pred_*",
                               full.names= TRUE )
