...
PARAM  <- list()
PARAM$experimento <- "FE7311" #0 sin aceleracion, 1 con aceleracion
...
PARAM$RandomForest$semilla  <- 211403    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 211403   # cambiar por la propia semilla
...
dataset_input  <- paste0( "./expfinal/", PARAM$exp_input, "/dataset.csv.gz" )

dataset  <- fread( dataset_input )

colnames( dataset )[ which( !( sapply( dataset, typeof) %in%  c("integer","double" ) )  ) ]

##AGREGO VARS DE ACELERACION################### SOLO EN PRUEBA FINAL
...
#"active_quarter", "tcuentas", "ctarjeta_visa_transacciones", "ctarjeta_master_transacciones", "cprestamos_personales", "cplazo_fijo", "cinversion1", "cinversion2", "ccuenta_debitos_automaticos", "cpagodeservicios", "ctransferencias_recibidas", "ctransferencias_emitidas", "cextraccion_autoservicio", "ccheques_depositados", "ccheques_emitidos", "ccheques_depositados_rechazados", "ccheques_emitidos_rechazados", "tcallcenter", "ccallcenter_transacciones", "thomebanking", "chomebanking_transacciones", "ccajas_transacciones", "ccajas_consultas", "ccajas_depositos", "ccajas_extracciones", "ccajas_otras", "catm_trx", "ctrx_quarter", "Master_delinquency", "Master_cconsumos", "Master_cadelantosefectivo", "Visa_cconsumos", "vm_cconsumos", "vm_cadelantosefectivo", "vmr_msaldototal", "vmr_msaldopesos", "vmr_msaldopesos2", "vmr_msaldodolares", "vmr_msaldodolares2", "vmr_mconsumospesos", "vmr_mconsumosdolares", "vmr_madelantopesos", "vmr_madelantodolares", "vmr_mpagado", "vmr_mpagospesos", "vmr_mconsumototal", "vmr_mpagominimo", "cmr_payroll", "fe_Visa_mpagos_saldo", "fe_mtarjeta_visa_consumo_pr", "fe_mplazo_fijos_pr", "fe_cseguros_pr", "fe_mpagodeservicios_pr", "fe_Master_msaldototal_pr", "fe_Master_mconsumospesos_pr", "fe_Master_mpagado_pr", "fe_Visa_msaldototal_pr", "fe_Visa_mconsumospesos_pr", "fe_Visa_mpagado_pr", "fe_Visa_mconsumototal_pr", "fe_Visa_mpagominimo_pr", "mrentabilidad_rank", "mcuenta_corriente_rank", "mcaja_ahorro_rank", "mcuentas_saldo_rank", "mautoservicio_rank", "mpayroll_rank", "mpayroll2_rank", "mtransferencias_recibidas_rank", "mtransferencias_emitidas_rank", "mcheques_depositados_rank", "mcheques_emitidos_rank", "Master_msaldopesos_rank", "Master_mconsumospesos_rank", "Master_madelantopesos_rank", "Master_mpagado_rank", "Master_mpagospesos_rank", "Visa_msaldototal_rank", "Visa_msaldopesos_rank", "Visa_mconsumospesos_rank", "Visa_madelantopesos_rank", "Visa_mpagado_rank", "Visa_mpagospesos_rank", "Visa_mconsumototal_rank", "Visa_mpagominimo_rank", "mpayroll_sobre_edad_rank", "vm_msaldototal_rank", "vm_msaldopesos_rank", "vm_mconsumospesos_rank", "vm_mpagado_rank", "vm_mpagospesos_rank", "vm_mconsumototal_rank", "vm_mpagominimo_rank", "m_tarjeta_visa_consumo_xtc_rank", "m_plazo_fijo_xplazo_rank", "m_inversiones_rank", "m_payrolls_rank", "m_payrolls_xpayroll_rank", "m_cmr_rank", "m_cmr_edad_rank"
#"ctarjeta_visa_transacciones", "cprestamos_personales", "ctransferencias_emitidas", "ccallcenter_transacciones", "chomebanking_transacciones", "ccajas_transacciones", "ccajas_consultas", "catm_trx", "ctrx_quarter", "Master_cconsumos", "Visa_cconsumos", "vmr_msaldototal", "vmr_msaldopesos", "vmr_msaldopesos2", "vmr_msaldodolares2", "vmr_mconsumospesos", "vmr_mconsumosdolares", "vmr_mpagospesos", "vmr_mpagominimo", "fe_Visa_mpagos_saldo", "fe_mtarjeta_visa_consumo_pr", "fe_Visa_msaldototal_pr", "fe_Visa_mconsumospesos_pr", "fe_Visa_mpagominimo_pr", "mrentabilidad_rank", "mcuenta_corriente_rank", "mcaja_ahorro_rank", "mcuentas_saldo_rank", "mautoservicio_rank", "mpayroll_rank", "mtransferencias_recibidas_rank", "mtransferencias_emitidas_rank", "Master_msaldopesos_rank", "Master_mconsumospesos_rank", "Master_mpagospesos_rank", "Visa_msaldototal_rank", "Visa_msaldopesos_rank", "Visa_mconsumospesos_rank", "Visa_mpagado_rank", "Visa_mpagospesos_rank", "Visa_mconsumototal_rank", "Visa_mpagominimo_rank", "mpayroll_sobre_edad_rank", "vm_msaldototal_rank", "vm_msaldopesos_rank", "vm_mconsumospesos_rank", "vm_mpagospesos_rank", "vm_mpagominimo_rank", "m_tarjeta_visa_consumo_xtc_rank", "m_plazo_fijo_xplazo_rank", "m_inversiones_rank", "m_cmr_rank", "m_cmr_edad_rank"
###############################################

#creo la carpeta donde va el experimento
dir.create( paste0( "./expfinal/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./expfinal/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
