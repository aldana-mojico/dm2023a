...
PARAM  <- list()
PARAM$experimento <- "TS741005V1"

PARAM$exp_input  <- "FE7310P2"
...
PARAM$train$training     <- c( 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907 )
PARAM$train$validation   <- c( 202106, 202105 )
