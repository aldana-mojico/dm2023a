...
PARAM  <- list()
PARAM$experimento <- "TS741005V15TA" 
#A sumo desde 201907 a train final (en orig ya estaba)
#B train final original (desde 201909) y sumo a test 202012 y lo saco de training
#C train final original (desde 201909) y sumo a test  202102, 201912 y lo saco de training

PARAM$exp_input  <- "FE7314P2"
...
#16A
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904 )
...
#PARAM$train$training     <- c( 202105, 202104, 202103, 202102, 202101, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906 )
#PARAM$train$validation   <- c( 202106 )
...
#PARAM$train$training     <- c( 202105, 202104, 202103, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201911, 201910, 201909, 201908, 201907, 201906, 201905 )
#PARAM$train$validation   <- c( 202106 )
#PARAM$train$testing      <- c( 202107, 202102, 201912 )
...
PARAM$train$semilla  <- 211403  # cambiar por su propia semilla  !!!
