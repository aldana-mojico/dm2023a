...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950US005V14TA" ##cambiar V0 V1 V2 // V3 V4
PARAM$exp_input  <- "HT7510US005V14" ##cambiar V0 V1 V2 // V3 V4

PARAM$modelos_rank  <- c( 1, 3, 4 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
PARAM$semillerio  <- 10   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
