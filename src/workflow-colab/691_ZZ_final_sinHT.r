...
dir.create( paste0( base_dir, "exp202104_HFijos/"), showWarnings= FALSE )
dir.create( paste0( base_dir, "exp202104_HFijos/", PARAM$experimento, "/"), showWarnings= FALSE )
setwd(paste0( base_dir, "exp202104_HFijos/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
...
arch_future  <- paste0( base_dir, "exp202104/", TS, "/dataset_future.csv.gz" )
