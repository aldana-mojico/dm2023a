...
PARAM$future       <- c( 202106, 202107, 202109 )
PARAM$final_train  <- c( 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904 )

PARAM$train$training     <- c( 202102, 202101, 202012, 202011, 202010, 202009, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904 )
...
dir.create( paste0( "./exp202106/"), showWarnings = FALSE )
dir.create( paste0( "./exp202106/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp202106/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
