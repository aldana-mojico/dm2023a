...
PARAM$trainingstrategy$semilla_azar   <- 211403  #Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 311453  #Aqui poner su segunda semilla
